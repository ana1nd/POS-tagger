# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 11:22:48 2016
...
def main() :
    ...
    with open("Brown_dev.txt","r") as f :
        for line in f :
            ...
            if len(ls_line)>mx :
                mx = len(ls_line)
                str=ls_line
            acc = viterbiAlgorithm(ls_line,tag_dict,transitional,emission,var_tag[z])
            sum += acc            
    ...
    return wordTag_dict,bigramTag_dict,tag_dict,wordCount_dict,transitional,emission
            
    


if __name__ == "__main__" :
    wordTag_dict,bigramTag_dict,tag_dict,wordCount_dict,transitional,emission = main()